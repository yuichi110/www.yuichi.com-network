...
たとえばルーティングテーブルのエントリとして「10.0.0.0/8は192.168.0.1経由」「10.1.0.0/16は192.168.0.2経由」というものがあるとします。
...
「/16」のほうが詳細なルートですので、宛先「10.1.0.1」宛のパケットの場合は「10.1.0.0/16は192.168.0.2経由」というエントリが採用されます。
